...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    private AddressBookMapper adderssBookMapper;
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        //处理业务异常（地址簿为空，购物车为空）
        AddressBook addressBook = adderssBookMapper.getById(ordersSubmitDTO.getAddressBookId());
        if(addressBook == null){
     ...
     */
    @Override
    public void cancleOrder(OrdersCancelDTO ordersCancelDTO) throws Exception{
        ...
        ordersDB.setId(orders.getId());
        ordersDB.setStatus(Orders.CANCELLED);
        ordersDB.setRejectionReason(ordersCancelDTO.getCancelReason());
        ordersDB.setCancelTime(LocalDateTime.now());
    }
